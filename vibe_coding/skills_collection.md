...
* ☑️ ZRead：github 项目深入理解，智谱出的，中文友好
* ☑️ Filesystem：文件系统管理
* ☑️ playwright：浏览器自动操作
* ☑️ Blender：3d 建模
* ☑️ github：代码托管
...
* ☑️ [coreyhaines31/marketingskills：marketing相关](https://github.com/coreyhaines31/marketingskills)([skills列表](vibe_coding/skills_collections/skills-marketingskills.md))
  * ☑️ copywriting：逻辑结构和表达优化
  * ☑️ social-content：社交媒体内容创作
  * ☑️ copy-editing：初稿精修
  * ☑️ seo-audit：做 seo 分析
  * ☑️ marketing-phychology：营销心理学的心理模型
  * ☑️ programmatic-seo：批量生成优化页面，做增长的秘密武器
  * ☑️ pricing-strategy：定价策略
  * ☑️ product-marketing-context：产品营销策略
  * ☑️ content-strategy：内容策略，不断给出选题
  * ☑️ marketing-ideas：营销策略
...
* ☑️ [ui-ux-pro-max-skill：UI 资源](https://github.com/nextlevelbuilder/ui-ux-pro-max-skill)
...
前端（Vue） + 云函数（复杂后端自己开发，可以用 Next.js 或者 Nuxt）+ uni-cloud（现成 MongoDB 数据库）

* ☑️ [uni-helper/skills@uni-app ](https://github.com/uni-helper/skills)
* ☑️ unicloud 相关可以直接阅读文档
